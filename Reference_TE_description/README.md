Here we eposited the scripts used to analize the TEs present in the reference. The TE library used to retrieve the models and the  TE annotation file can be found in: <br>
